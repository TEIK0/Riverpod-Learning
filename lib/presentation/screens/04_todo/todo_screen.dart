  ...
  Widget build(BuildContext context, WidgetRef ref) {
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          ref.watch(todosProvider.notifier).createTodo(RandomGenerator.getRandomName());
        },
      ),
    );
  }
...
class _TodoView extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final todoCurrentFilter = ref.watch(todoCurrentFilterProvider);
    ...
    return Column(
      children: [
        ...
        SegmentedButton(
          ...
          selected: <FilterType>{ todoCurrentFilter },
